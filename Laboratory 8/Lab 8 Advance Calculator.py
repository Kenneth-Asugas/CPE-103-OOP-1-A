...
tk.Label(root, text="Enter second number:", font=("Arial", 14), bg="gray").grid(row=1, column=0)
...
tk.Label(root, text="Result:", font=("Arial", 12), bg="gray").grid(row=8, column=0)
...
tk.Label(root, text="History:", font=("Arial", 12), bg="gray").grid(row=14, column=0)
